function viewcell4a(cellid,Partitions,varargin)
% Lets try to hack this for plotting LaserStim Events and BackNForth
% VIEWCELL
%
%   
...
% end
valid_trials=1:size(COMPTRIALS{1},2);
...
plot_timecourse(time,spsth,spsth_se,g,'FigureNum',fhandle0(2),'Colors',{mycolors},'LineStyle',{mylinestyle},'Legend',{mylabels},'XLabel',XLabel,'YLabel',YLabel);
