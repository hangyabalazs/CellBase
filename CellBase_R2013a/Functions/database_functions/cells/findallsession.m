function sessionids = findallsession(varargin)
%FINDALLSESSION   Locate sessions in CellBase.
%   FINDALLSESSION returns the session ID(s) in CellBase for a particular
...
%
%   Syntax:
%   SESSIONIDS = FINDALLSESSION('ANIMAL',ANIMALID)
%   SESSIONIDS = FINDALLSESSION('DATE',DATE)
%   SESSIONIDS = FINDALLSESSION('ANIMAL',ANIMALID,'DATE',DATE)
%
%   See also FINDCELL.
...
% All sessions
sessionids = listtag('allsessions');
