function handles = viewpoppsth3_stim(cellids,partition,varargin)
...
try, g.TriggerName;    catch, g.TriggerName  = 'BurstOn'; end;
...
TE = loadcb(cellids{1},'Stimevent');
SP = loadcb(cellids{1},'StimSpikes');
