...
if pHit == 0 % if 0% Hits
% if e.g. 50 signal present trials Hits is between 0-2%
% make Hits 1/N2 [1/(2*50) = .01]
% N is the number of signal present trials
pHit = 1/(2*PresentT); %
end
if pFA == 1 % if 100% False Alarms
% if e.g. 50 signal present trials False Alarms is between 98-100%
% make False Alarms 1-(1/N2) [1-(1/(2*50)) = .99]
