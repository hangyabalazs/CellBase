function rtcurves_tuning(cellids,varargin)
...
for k = 1:NumCell
    ...
    hitfilter = 'selectGoRT_tuning'; %#ok<NASGU>
    fafilter = 'selectNoGoRT_tuning'; %#ok<NASGU>
