function s = nancell2struct(s)
%NANCELL2STRUCT   Convert cell of structures with NaNs to struct.
%   S = NANCELL2STRUCT(C) converts a cell array of structures with the same
%   fields (C) into a struct (S). Fields are left empty for NaNs in C.
%
